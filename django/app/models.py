...
class TrackType(models.Model):
    track_type_id = models.AutoField(
        primary_key=True, db_column="track_type_id")
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(check=models.Q(
                start_age__gt=0), name='check_start_age_gt_0'),
            models.CheckConstraint(check=models.Q(end_age__gte=models.F(
                'start_age')), name='check_end_age_gte_start_age'),
            models.CheckConstraint(check=models.Q(
                max_lessons_number__gt=0), name='check_max_lessons_number_gt_0'),
            models.UniqueConstraint(
                fields=['start_age', 'end_age'], name='unique_age')
        ]
...
class Group(models.Model):
    ...
    group_name = models.CharField(
        max_length=64, null=False, db_column="group_name")
    track_type = models.ForeignKey(
        TrackType, on_delete=models.CASCADE, db_column="track_type")
...
class Child(models.Model):
    ...
    patronymic = models.CharField(
        max_length=64, blank=True, null=True, db_column="patronymic")
    ...
    add_to_group_date = models.DateField(
        auto_now_add=True, null=True, db_column="add_to_group_date")
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(check=models.Q(
                birthday__lt=models.functions.Now()), name='check_birthday_lt_current_date')
        ]
...
class ParentByChild(models.Model):
    parent_id = models.ForeignKey(
        Parent, on_delete=models.CASCADE, db_column="parent_id")
    child_id = models.ForeignKey(
        Child, on_delete=models.CASCADE, db_column="child_id")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['parent_id', 'child_id'], name='primary_parent_by_child')
        ]
...
class ParentPhone(models.Model):
    ...
    phone_number = models.CharField(
        max_length=14, null=False, db_column="phone_number")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['parent_id', 'phone_number'], name='unique_parent_phone')
        ]
...
class Worker(models.Model):
    ...
    dismissal_date = models.DateField(
        blank=True, null=True, db_column="dismissal_date")
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(check=models.Q(
                hire_date__lte=models.functions.Now()), name='check_hire_date_le_current_date'),
            models.CheckConstraint(check=models.Q(dismissal_date__gt=models.F(
                'hire_date')), name='check_dismissal_date_gt_hire_date')
        ]
...
class Role(models.Model):
    level_code = models.CharField(
        max_length=1, primary_key=True, db_column="level_code")
    role_name = models.CharField(
        max_length=32, unique=True, null=False, db_column="role_name")
    eng_role_name = models.CharField(
        max_length=32, null=False, db_column="eng_role_name")
...
class WorkerByRole(models.Model):
    level_code = models.ForeignKey(
        Role, on_delete=models.CASCADE, db_column="level_code")
    worker_id = models.ForeignKey(
        Worker, on_delete=models.CASCADE, db_column="worker_id")
    tensure_start_date = models.DateField(
        auto_now_add=True, db_column="tensure_start_date")
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(check=models.Q(
                tensure_start_date__lte=models.functions.Now()), name='check_tens_st_date_le_curr_date'),
            models.UniqueConstraint(
                fields=['level_code', 'worker_id'], name='primary_worker_role')
        ]
...
class LoginData(models.Model):
    worker_login = models.CharField(
        max_length=64, primary_key=True, db_column="worker_login")
    worker_id = models.ForeignKey(
        Worker, on_delete=models.CASCADE, db_column="worker_id")
...
class WorkerHistory(models.Model):
    ...
    level_code = models.ForeignKey(
        Role, on_delete=models.CASCADE, db_column="level_code")
    tensure_start_date = models.DateField(
        null=False, db_column="tensure_start_date")
    tensure_end_date = models.DateField(
        null=False, db_column="tensure_end_date")
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.CheckConstraint(
                check=models.Q(tensure_end_date__gte=models.F(
                    'tensure_start_date')),
        ...
        indexes = [
            models.Index(
                fields=['worker_id', 'level_code', 'tensure_start_date']),
        ]
...
class Course(models.Model):
    ...
    course_name = models.CharField(
        max_length=128, null=False, db_column="course_name")
...
class MarkCategory(models.Model):
    mark_category = models.CharField(
        max_length=32, primary_key=True, db_column="mark_category")
    description = models.CharField(
        max_length=96, null=False, db_column="description")
...
class MarkType(models.Model):
    ...
    description = models.CharField(
        max_length=512, null=False, db_column="description")
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(check=models.Q(
                min_value__gte=0), name='check_min_value_gte_0'),
            models.CheckConstraint(check=models.Q(max_value__gt=models.F(
                'min_value')), name='check_max_value_gt_min_value')
        ]
...
class CourseByMarkType(models.Model):
    ...
    mark_type = models.ForeignKey(
        MarkType, on_delete=models.CASCADE, db_column="mark_type")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['course_id', 'mark_type'], name='primary_course_by_mark')
        ]
...
class CourseAuthor(models.Model):
    ...
    author_id = models.ForeignKey(
        Worker, on_delete=models.CASCADE, db_column="author_id")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['course_id', 'author_id'], name='primary_course_by_author')
        ]
...
class GroupClass(models.Model):
    ...
    teacher_id = models.ForeignKey(
        Worker, on_delete=models.CASCADE, db_column="teacher_id")
    course_id = models.ForeignKey(
        Course, on_delete=models.CASCADE, db_column="course_id")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['teacher_id', 'group_id', 'course_id'], name='unique_class')
        ]
...
class ClassHistory(models.Model):
    ...
    class_id = models.ForeignKey(
        GroupClass, on_delete=models.CASCADE, db_column="class_id")
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(check=models.Q(
                add_date__lte=models.functions.Now()), name='check_add_date_le_current_date'),
            models.CheckConstraint(check=models.Q(leave_date__gte=models.F(
                'add_date')), name='check_leave_date_ge_add_date'),
            models.UniqueConstraint(
                fields=['child_id', 'class_id'], name='primary_class_history')
        ]
...
class CourseComment(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['course_id', 'author_id'], name='primary_course_comments')
        ]
...
class ChildInfo(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['child_id', 'author_id'], name='primary_child_info')
        ]
...
class ClassInfo(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['class_id', 'author_id'], name='primary_class_info')
        ]
...
class Semester(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(check=models.Q(end_date__gt=models.F(
                'start_date')), name='check_end_date_gt_start_date')
        ]
...
class Lesson(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['class_id', 'lesson_date'], name='primary_lesson')
        ]
...
class Report(models.Model):
    ...
    class_id = models.ForeignKey(
        GroupClass, on_delete=models.CASCADE, db_column="class_id")
    semester = models.ForeignKey(
        Semester, on_delete=models.CASCADE, db_column="semester_id")
    filename = models.CharField(
        max_length=128, null=False, db_column="filename")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['child_id', 'class_id', 'semester', 'filename'], name='primary_reports')
        ]

        indexes = [
            models.Index(fields=['class_id', 'semester']),
            models.Index(
                fields=['child_id', 'class_id', 'semester', 'filename'])
        ]
...
class Visits(models.Model):
    ...
    lesson_date = models.DateTimeField(null=False, db_column="lesson_date")
    description = models.CharField(
        max_length=96, null=True, db_column="description")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['child_id', 'class_id', 'lesson_date'], name='unique_visit')
        ]
    ...
    def clean(self):
        ...
        if not Lesson.objects.filter(class_id=self.class_id, lesson_date=self.lesson_date).exists():
            raise ValidationError(
                'Invalid combination of class_id and lesson_date.')
...
class GroupCreators(models.Model):
    ...
    curator_id = models.ForeignKey(
        Worker, on_delete=models.CASCADE, db_column="curator_id")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['group_id', 'curator_id'], name='primary_group_by_creator')
        ]
...
class MarksForVisit(models.Model):
    # \brief Foreign key to Visits.
    visit = models.ForeignKey(
        Visits, on_delete=models.CASCADE, db_column="visit_id")
    # \brief Foreign key to MarkTypes.
    mark_type = models.ForeignKey(
        MarkType, on_delete=models.CASCADE, db_column="mark_type")
    # \brief The mark given.
    mark = models.DecimalField(
        max_digits=3, decimal_places=1, db_column="mark")
...
def check_add_semester(sender, instance, **kwargs):
    if Semester.objects.filter(
        ...
        models.Q(start_date__lte=instance.end_date,
                 end_date__gte=instance.end_date)
    ).exists():
...
def add_to_history_when_delete(sender, instance, **kwargs):
    LoginData.objects.filter(worker_id=instance.worker_id,
                             level_code=instance.level_code).delete()
...
def update_login_data(sender, instance, **kwargs):
    if instance.pk:
        ...
        LoginData.objects.filter(worker_id=old_instance.worker_id, level_code=old_instance.level_code).update(
            level_code=instance.level_code)
